...
COPY public.clients (id, "ФИО", "страна проживания", "заказ", order_id) FROM stdin;
4	Ронни Джеймс Дио	Russia	\N	\N
5	Ritchie Blackmore	Russia	\N	\N
1	Иванов Иван Иванович	USA	\N	3
2	Петров Петр Петрович	Canada	\N	4
3	Иоганн Себастьян Бах	Japan	\N	5
\.
